...
#
# ReNameAbleClass
# and the special one method should be change_class_name Like before,
# be sure that new solution will allow only names with alphanumeric chars (upper & lower letters plus digits),
...
class ReNameAbleClass(object):
    ...
    def change_class_name(cls, new_name):
        assert new_name[0].isalpha() and new_name[0].isupper() and new_name[1:].isalnum()
